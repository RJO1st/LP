    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <main className="max-w-2xl mx-auto px-3 sm:px-6 pt-6 sm:pt-12">
        ...
        <div className="bg-white border-2 sm:border-4 border-slate-100 border-b-4 sm:border-b-8 rounded-2xl sm:rounded-[32px] p-4 sm:p-8 mb-4 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-black mb-4 sm:mb-6">Account Details</h2>
        ...
        {/* DANGER ZONE */}
        {/* ═══════════════════════════════════════════════════════ */}
        <div className="bg-white border-2 sm:border-4 border-rose-100 border-b-4 sm:border-b-8 rounded-2xl sm:rounded-[32px] p-4 sm:p-8">
