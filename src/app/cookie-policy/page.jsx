...
// ─── Named sub-component — identical to terms-page ────────────────────────────
  ...
  return (
    <div className="space-y-3">
      {blocks.map((b, i) => {
        ...
        if (b.type === 'table') {
          return (
            <div key={i} className="overflow-x-auto mt-2 rounded-xl border border-slate-200">
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr style={{ background: 'linear-gradient(135deg, #eef2ff, #f5f3ff)' }}>
                    {b.headers.map((h, hi) => (
                      <th key={hi} className="text-left px-4 py-3 font-black text-indigo-700 border-b border-indigo-100 whitespace-nowrap">
                        {h}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {b.rows.map((row, ri) => (
                    <tr key={ri} className={ri % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'}>
                      {row.map((cell, ci) => (
                        <td key={ci} className="px-4 py-3 text-slate-600 border-b border-slate-100 last:border-b-0 leading-relaxed align-top">
                          {cell}
                        </td>
                      ))}
                    </tr>
...
export default function CookiePolicyPage() {
  const sections = [
    ...
    },
    {
      ...
      blocks: [
        { type: 'table',
          headers: ['Cookie / Technology', 'Type', 'Purpose', 'Duration'],
          rows: [
            ...
            ['posthog_*',          'Analytics',          'Anonymised usage analytics (page views, feature engagement). No personal data stored.', 'Up to 1 year'],
          ],
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: `We cannot provide the ${PLATFORM} service without these cookies. Blocking them in your browser settings will prevent you from logging in.` },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: `Our analytics provider (PostHog) processes data on servers within the EU. No personally identifiable information is sent. IP addresses are anonymised before storage. You can opt out of analytics cookies at any time by contacting us at ${EMAIL}.` },
      ],
    },
    {
      ...
      blocks: [
        ...
        { type: 'list', items: [
          'Supabase — authentication and real-time database infrastructure. Privacy policy at supabase.com/privacy.',
          'Vercel — hosting and edge delivery infrastructure. Privacy policy at vercel.com/legal/privacy-policy.',
          'PostHog — anonymised product analytics. Privacy policy at posthog.com/privacy.',
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: `When you first visit ${PLATFORM}, a cookie banner will appear. You can accept all cookies, accept only necessary cookies, or customise your preferences. You can revisit your choices at any time by clicking "Cookie Settings" in the footer.` },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'list', items: [
          ...
          'Functional cookies: Consent — we will ask before placing these where required by law.',
      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-indigo-200/70 text-sm mt-3 max-w-xl">
            This policy explains what cookies {PLATFORM} uses, why we use them, and how you can manage them.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-5">
            ...
            >
              <p className="text-slate-700 text-sm leading-relaxed">
                We use cookies and similar technologies to keep {PLATFORM} secure, personalise your experience,
                and understand how the platform is used. We never use cookies to serve advertising.
                This policy explains exactly what we use, why, and how you can control it.
              </p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
              <p className="text-sm text-slate-500">
                This Cookie Policy was last updated on <strong className="text-slate-700">{UPDATED}</strong>.
