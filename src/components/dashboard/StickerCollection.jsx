...
const MILESTONES = {
  ...
  ks3: [
    { id: "first_challenge", label: "First Challenge",   emoji: "📋", threshold: (m) => m.questsCompleted >= 1, desc: "Complete your first challenge" },
    { id: "challenge_20",    label: "Consistent",         emoji: "📊", threshold: (m) => m.questsCompleted >= 20, desc: "Complete 20 challenges" },
    { id: "challenge_50",    label: "Dedicated",          emoji: "💪", threshold: (m) => m.questsCompleted >= 50, desc: "Complete 50 challenges" },
    { id: "streak_7",        label: "Week Streak",        emoji: "🔥", threshold: (m) => m.streak >= 7, desc: "7-day learning streak" },
    { id: "streak_30",       label: "Monthly Master",     emoji: "⚡", threshold: (m) => m.streak >= 30, desc: "30-day learning streak" },
    { id: "mastery_70",      label: "Proficient",         emoji: "📈", threshold: (m) => (m.masteryPct ?? 0) >= 70, desc: "Reach 70% mastery" },
    { id: "mastery_90",      label: "Expert",             emoji: "🏆", threshold: (m) => (m.masteryPct ?? 0) >= 90, desc: "Reach 90% mastery" },
    { id: "xp_1000",         label: "1K Club",            emoji: "🎖️", threshold: (m) => m.totalXP >= 1000, desc: "Earn 1000 XP" },
  ],
  ks4: [
    { id: "first_revision",  label: "Revision Started",  emoji: "📝", threshold: (m) => m.questsCompleted >= 1, desc: "Complete first revision session" },
    { id: "revision_30",     label: "Committed",          emoji: "📚", threshold: (m) => m.questsCompleted >= 30, desc: "30 revision sessions" },
    { id: "streak_7",        label: "Week Streak",        emoji: "🔥", threshold: (m) => m.streak >= 7, desc: "7-day revision streak" },
    { id: "streak_30",       label: "Iron Discipline",    emoji: "⚡", threshold: (m) => m.streak >= 30, desc: "30-day revision streak" },
    { id: "mastery_80",      label: "Grade 7+",           emoji: "🎯", threshold: (m) => (m.masteryPct ?? 0) >= 80, desc: "80% mastery across subjects" },
    { id: "mastery_95",      label: "Grade 9",            emoji: "🏆", threshold: (m) => (m.masteryPct ?? 0) >= 95, desc: "95% mastery across subjects" },
    { id: "mock_pass",       label: "Mock Ready",         emoji: "📊", threshold: (m) => (m.mocksCompleted ?? 0) >= 1, desc: "Complete a mock exam" },
    { id: "xp_2000",         label: "2K Scholar",         emoji: "💎", threshold: (m) => m.totalXP >= 2000, desc: "Earn 2000 XP" },
  ],
};
