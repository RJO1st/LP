...
export const BAND_CONFIGS = {
  ...
  ks2: {
    ...
    colours: {
      bg:"linear-gradient(165deg,#fef7ed 0%,#fef3e2 30%,#fdf2d1 50%,#fef9f0 100%)", bgSolid:"#fef7ed",
      card:"rgba(255,255,255,0.9)", cardBorder:"rgba(99,102,241,.18)",
      accent:"#6366f1", accentDark:"#4f46e5", accentLight:"rgba(99,102,241,.12)",
      success:"#10b981", successBg:"rgba(16,185,129,.12)", error:"#ef4444", errorBg:"rgba(239,68,68,.10)",
      text:"#1e1b4b", textMuted:"#7c6fdb", textOnAccent:"#ffffff",
    },
  ...
  ks3: {
    ...
    colours: {
      bg:"#0c0f1a", bgSolid:"#0c0f1a",
      card:"rgba(255,255,255,0.06)", cardBorder:"rgba(255,255,255,0.08)",
      accent:"#0ea5e9", accentDark:"#0284c7", accentLight:"#e0f2fe",
      success:"#22c55e", successBg:"rgba(34,197,94,0.15)", error:"#ef4444", errorBg:"rgba(239,68,68,0.12)",
      text:"#f1f5f9", textMuted:"rgba(203,213,225,0.7)", textOnAccent:"#ffffff",
    },
  ...
  ks4: {
    ...
    colours: {
      bg:"#0a0a14", bgSolid:"#0a0a14",
      card:"rgba(18,16,32,0.7)", cardBorder:"rgba(139,92,246,0.12)",
      accent:"#8b5cf6", accentDark:"#6d28d9", accentLight:"rgba(139,92,246,0.08)",
      success:"#34d399", successBg:"rgba(52,211,153,0.1)", error:"#f87171", errorBg:"rgba(248,113,113,0.1)",
      text:"#eee8ff", textMuted:"rgba(196,181,253,0.65)", textOnAccent:"#ffffff",
    },
